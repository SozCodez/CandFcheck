...
print("Enter 3 more whole numbers:")
print()
value1 = input()
value2 = input()
value3 = input()
...
# OR
# Not increasing
print("Sorry, but I need 3 more numbers..")
print()
n1 = input()
n2 = input()
n3 = input()
...
# All different
# if none match
print("You're never gonna guess, three more numbers please:")
print()
a = input()
b = input()
c = input()
